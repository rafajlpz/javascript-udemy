...
const cuenta = 275;
const calculadorDePropina =
  cuenta >= 50 && cuenta <= 300 ? cuenta * 0.15 : cuenta * 0.2;

console.log(`La cuenta correspondiente con el iva total es de ${cuenta+calculadorDePropina}`);
